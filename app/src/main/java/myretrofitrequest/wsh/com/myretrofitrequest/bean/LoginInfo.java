package myretrofitrequest.wsh.com.myretrofitrequest.bean;
...
public class LoginInfo implements Serializable{
    ...
    public String toString() {
        return "LoginInfo{" +
                ...
                ", birthday='" + birthday + '\'' +
                ", frozencoin='" + frozencoin + '\'' +
                ", sex='" + sex + '\'' +
                ", taobaoOpenid='" + taobaoOpenid + '\'' +
                ", score='" + score + '\'' +
                ...
                ", mobile='" + mobile + '\'' +
                ", brokerValidate='" + brokerValidate + '\'' +
                ", scienerUsername='" + scienerUsername + '\'' +
                ", baichuanUid='" + baichuanUid + '\'' +
                ", walletPassword='" + walletPassword + '\'' +
                ", auto_login_code='" + auto_login_code + '\'' +
                ", has_charge='" + has_charge + '\'' +
                ", paySecret='" + paySecret + '\'' +
                ", alibaichuanId='" + alibaichuanId + '\'' +
                ", authCode='" + authCode + '\'' +
